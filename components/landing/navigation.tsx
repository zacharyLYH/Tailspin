...
export const Navigation = () => {
    return (
        <div className='fixed left-0 right-0 top-0 z-50 ml-3 mt-2 flex flex-row gap-8'>
            <TailspinLogo outershellClassname='h-10 w-10 animate-spin' />
            <NavigationMenu>
                <NavigationMenuList>
                    <NavigationMenuItem>
                        ...
                        <NavigationMenuContent>
                            <ul className='grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]'>
                                ...
                                <ListItem href='/#stepper' title='Try it out!'>
                                    Try out Tailspin. Just follow the steps and
                                    happy coding!
                                </ListItem>
